...
static const GDBusArgInfo * const _min_min_bus_gdbus_method_info_hello_world_IN_ARG_pointers[] =
{
  &_min_min_bus_gdbus_method_info_hello_world_IN_ARG_greeting.parent_struct,
  NULL
};
...
static const GDBusArgInfo * const _min_min_bus_gdbus_method_info_hello_world_OUT_ARG_pointers[] =
{
  &_min_min_bus_gdbus_method_info_hello_world_OUT_ARG_response.parent_struct,
  NULL
};
...
static const GDBusMethodInfo * const _min_min_bus_gdbus_method_info_pointers[] =
{
  &_min_min_bus_gdbus_method_info_hello_world.parent_struct,
  NULL
};
